...
Revision ID: dd38dd3904c1
Revises: 2d870fa75fe5
Create Date: 2020-01-31 16:18:10.360033
...
revision = 'dd38dd3904c1'
down_revision = '2d870fa75fe5'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('user_float', sa.Integer(), nullable=False),
    sa.Column('float_history', sa.String(), nullable=False),
